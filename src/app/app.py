...
def init_dash_app(read_interval: float = 10) -> dash.Dash:
    ...
    app.layout = dbc.Container(
        children=[
            ...
            dcc.Store("unit_store", storage_type="session"),
            dcc.Store("cur_game_id", storage_type="session"),
            dcc.Store("game_state", storage_type="memory"),
            dcc.Store("game_store", storage_type="memory"),
            dcc.Store("last_tick_store", storage_type="session"),
            dcc.Store("lord_names", storage_type="session"),
